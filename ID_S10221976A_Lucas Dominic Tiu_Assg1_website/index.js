...
// Type it script to make that cool effect
...
new TypeIt("#type2", {
  ...
  .type("Cheerful", { delay: 400 })
  .pause(500)
  .delete(8)
  .type("Helpful", { delay: 400 })
  .pause(500)
  .delete(7)
  ...
  .pause(500)
  .delete(12)
  .type("a Asuna enthusiast", { delay: 400 })
  .pause(500)
  .delete(9)
  .go();


//script for web animation
...
//Script for the gliding effect thing for Gallery
